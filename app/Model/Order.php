 ...
 * @property-read \Hyperf\Database\Model\Collection|\App\Model\OrderGood[] $orderGoods
 */
class Order extends Model
{
     ...
     * @var array
     */
    protected $casts = ['order_id' => 'integer', 'order_sort' => 'integer', 'seller_id' => 'integer', 'store_id' => 'integer', 'shops_id' => 'integer', 'prom_type' => 'integer', 'prom_success' => 'integer', 'order_type' => 'integer', 'delivery_type' => 'integer', 'delivery_company_id' => 'integer', 'user_id' => 'integer', 'bee_id' => 'integer', 'order_status' => 'integer', 'pay_status' => 'integer', 'refund_status' => 'integer', 'address_id' => 'integer', 'send_time' => 'integer', 'create_time' => 'integer', 'send_day' => 'integer', 'pay_type' => 'integer', 'pay_time' => 'integer', 'is_free_distribution' => 'integer', 'integral' => 'integer', 'integral_money' => 'float', 'plastic_price' => 'float', 'shipping_price' => 'float', 'supply_shipping_price' => 'float', 'goods_price' => 'float', 'market_price' => 'float', 'deposit' => 'float', 'booking_payment' => 'float', 'deduct' => 'float', 'discount' => 'float', 'final_payment' => 'float', 'return_amount' => 'float', 'total_amount' => 'float', 'weight' => 'integer', 'add_time' => 'integer', 'confirm_time' => 'integer', 'arrive_time' => 'integer', 'shipping_time' => 'integer', 'is_comment' => 'integer', 'deleted' => 'integer', 'order_status_tmp' => 'integer', 'close_type' => 'integer', 'look_status' => 'integer', 'update_time' => 'integer', 'picking_time' => 'integer', 'picking_id' => 'integer', 'verify_id' => 'integer', 'delivery_id' => 'integer', 'create_order_id' => 'integer', 'independent' => 'integer'];
