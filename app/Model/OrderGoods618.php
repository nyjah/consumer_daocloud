 ...
 * @property string $ts 
 */
class OrderGoods618 extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'order_goods_618';
    /**
